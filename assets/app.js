(function () {
  ...
  function settingsUnlocked() {
    return sessionStorage.getItem(SETTINGS_UNLOCK_KEY) === '1';
  }

  function doUnlockSettings() {
    const input = document.getElementById('settingsPwd');
    if (input && input.value === getSettingsPwd()) {
